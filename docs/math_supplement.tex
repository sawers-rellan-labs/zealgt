...
\label{eq:bulkmix}
\end{equation}
which keeps the $12.5\%$ donor content of Text~\ref{sec:scheme}. \todo{which generation is the bulk's parent: BC$_2$S$_2$ (used here) or BC$_2$S$_3$ (then $h=1/32$, $a=7/64$, B73 $=55/64$ in Eq.~\eqref{eq:bulkmix})} The chr10 genotype frequencies of the two full-coverage mexicana families (84 lines) are closer to the BC$_2$S$_2$ expectation, with an excess of HET and a deficit of introgression against it (PLAN\_pipeline \S4 \#12). Within a segment where the parent is heterozygous, $K$ is constant between
