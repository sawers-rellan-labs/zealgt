...
\paragraph{Ancestry inference.} Per line, RTIGER \citep{campos2023rtiger} on the donor's own tier-A sites (rigidity 500; RTIGER learns its transition and emission parameters from the data, so no design prior enters --- the BC$_2$S$_2$ vs BC$_2$S$_3$ question needs a design-aware caller)
